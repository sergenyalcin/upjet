...
replace github.com/crossplane/crossplane-runtime => github.com/erhancagirici/crossplane-runtime v0.0.0-20250709142654-998b18a399d2

require (
	dario.cat/mergo v1.0.2
	github.com/alecthomas/kingpin/v2 v2.4.0
	github.com/antchfx/htmlquery v1.2.4
	github.com/crossplane/crossplane v1.21.0-rc.0.0.20250624054852-c47b065786b5
